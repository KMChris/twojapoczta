...
export const api = {
  ...
  zmienWiele: (ids, dane) => zadanie('PATCH', '/api/messages', { ids, ...dane }),
  usun: (id) => zadanie('DELETE', `/api/messages/${id}`),
  usunWiele: (ids) => zadanie('DELETE', '/api/messages', { ids }),
  ...
  reguly: () => zadanie('GET', '/api/rules'),
  dodajRegule: (dane) => zadanie('POST', '/api/rules', dane),
  zmienRegule: (id, dane) => zadanie('PATCH', `/api/rules/${id}`, dane),
  usunRegule: (id) => zadanie('DELETE', `/api/rules/${id}`),
  zastosujRegule: (id) => zadanie('POST', `/api/rules/${id}/apply`),
